...
for n in pairs(_G) do
  if not ({___Glob = 1, tostring = 1, assert = 1, total_assertions = 1, passed_assertions = 1, TestCoverage = 1})[n] then
    _G[n] = nil
  end
end
...
print("Overall: " .. tostring(passed_assertions) .. "/" .. tostring(total_assertions) .. " passed")