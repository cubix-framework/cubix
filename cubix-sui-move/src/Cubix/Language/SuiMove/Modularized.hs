{- |
   ...
   This file was generated by the gen-mod executable from cubix-tree-sitter.

   To regenerate, run:
     cabal run gen-mod -- <path-to-grammar.json> \
...
data ModuleExtensionDefinitionL
...
data SourceFile e l where
  SourceFile
    :: e [SourceFileInternal0L]
    -> SourceFile e SourceFileL

data SourceFileInternal0 e l where
  SourceFileInternal0ModuleExtensionDefinition
    :: e ModuleExtensionDefinitionL
    -> SourceFileInternal0 e SourceFileInternal0L
  SourceFileInternal0ModuleDefinition
    :: e ModuleDefinitionL
    -> SourceFileInternal0 e SourceFileInternal0L
...
data HiddenLiteralValue e l where
  ...
  HiddenLiteralValueByteStringLiteral
    ...
    -> HiddenLiteralValue e HiddenLiteralValueL
  HiddenLiteralValueStringLiteral
    :: e StringLiteralL
    -> HiddenLiteralValue e HiddenLiteralValueL
...
data StringLiteral e l where
  StringLiteral
    :: Text
    -> StringLiteral e StringLiteralL
...
data QuantifierExpression e l where
  QuantifierExpression
    :: e ((((QuantifierExpressionInternal0L, QuantifierBindingsL), Maybe (WhereTokL, HiddenExpressionL)), ColonTokL), HiddenExpressionL)
...
data QuantifierExpressionInternal0 e l where
  QuantifierExpressionInternal0Forall
    :: e HiddenForallL
    -> QuantifierExpressionInternal0 e QuantifierExpressionInternal0L
  QuantifierExpressionInternal0Exists
    :: e HiddenExistsL
    -> QuantifierExpressionInternal0 e QuantifierExpressionInternal0L
...
data ModuleExtensionDefinition e l where
  ModuleExtensionDefinition
    :: e ExtendTokL
    -> e ModuleDefinitionL
    -> ModuleExtensionDefinition e ModuleExtensionDefinitionL
