...
do
  ...
  res, msg = pcall(old_assert, false, "X", t)
  assert(not res and msg == "X")
 
  -- 'assert' with no message
  res, msg = pcall(function () old_assert(false) end)
  ...
  res, msg = pcall(old_assert, false, t)
  assert(not res and msg == t)

  res, msg = pcall(old_assert, nil, nil)
  assert(not res and msg == nil)

  -- 'assert' without arguments
  res, msg = pcall(old_assert)
